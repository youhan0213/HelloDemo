...
public interface AppMapper {
	...
	public List<AppDetailBean> searchApp(@Param("appName")String appName, @Param("appType")String appType,@Param("start") Integer start,@Param("psize") Integer psize, @Param("appId")Integer appId,@Param("appVersionId")Long appVersionId, @Param("onUse")Integer onUse, @Param("packageName")String packageName, @Param("area")String area, @Param("menuId")Integer menuId);
